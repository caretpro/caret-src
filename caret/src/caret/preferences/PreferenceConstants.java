...
public class PreferenceConstants {
	...
	public static final String P_LIST_VALIDATORS = "listValidatorsPreference";
	public static final String P_LIST_TASKS = "listTasksPreference";
	public static final String P_TABLE_TASKS = "TableTasksPreference";
	public static final String P_CONTEXT_EXTENDED_CLASS = "ContextExtendedClassPreference";
	public static final String P_CONTEXT_IMPLEMENTED_INTERFACE = "ContextImplementedInterfacePreference";
