 ...
 * </p>
 */
public abstract class ListEditorData extends FieldEditor {
    ...
    /**
     * Internal list of items to keep in sync with the SWT List.
     */
    private java.util.List<String> listItems = new ArrayList<>();

    /**
     * Creates a new list field editor
     */
    protected ListEditorData() {
    }
     ...
     */
    protected ListEditorData(java.util.List<String> items, String labelText, Composite parent) {
        listItems.addAll(items);
        init("dummy", labelText); // no preference name needed
    ...
    private void addPressed() {
        ...
        if (input != null) {
            ...
            if (index >= 0) {
                ...
                listItems.add(index + 1, input);
            } else {
                list.add(input, 0);
                listItems.add(0, input);
            }
            selectionChanged();
        }
    }
    ...
    private void swap(boolean up) {
        ...
        if (index >= 0) {
            ...
            listItems.remove(index);
            listItems.add(target, selection[0]);
