...
import caret.agent.gpt.preferences.PreferenceConstants;
...
public class AgentGPT implements AgentInterface{
	
	private IPreferenceStore store;
	private String ID = "GPT";
	private String name = "GPT";
	...
	public Response processMessage(String message, float temperature) {
		...
		key = store.getString(PreferenceConstants.P_GPT_KEY);
		model = store.getString(PreferenceConstants.P_GPT_MODEL);
		url = store.getString(PreferenceConstants.P_GPT_URL);
		...
		try {
			...
			String responseBody = result.toString();
	   	 	caret.agent.gpt.QueryResponse queryResponse = gson.fromJson(responseBody, caret.agent.gpt.QueryResponse.class);
